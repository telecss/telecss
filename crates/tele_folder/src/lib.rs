...
pub trait Folder {
  fn fold_ss_node(&mut self, mut ss_node: StyleSheetNode) -> StyleSheetNode {
  ...
  fn fold_rule_set_node(&mut self, mut rule_set_node: RuleSetNode) -> RuleSetNode {
  ...
  fn fold_at_rule_node(&mut self, mut at_rule_node: AtRuleNode) -> AtRuleNode {
  ...
  fn fold_decl_node(&mut self, decl_node: DeclarationNode) -> DeclarationNode {
